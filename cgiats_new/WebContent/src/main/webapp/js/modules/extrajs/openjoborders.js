;(function(angular){
	"use strict";
	angular.module("openJobOrdersApp", ['jcs-autoValidate', 'ui.bootstrap',  'ngTable'])
	
	
.directive('maskphone', function($http) {
    return {
       // requiring ng-model directive on the element
	...
	.controller("openJobOrdersController", function($scope, $http, $location, NgTableParams){
		...
		$scope.onload = function()
		{
			...
			$scope.resumeStats.resumeStatsTableControl.options.data = [{"users" :"qwe","downloadCount":"ddff"}];
		}
