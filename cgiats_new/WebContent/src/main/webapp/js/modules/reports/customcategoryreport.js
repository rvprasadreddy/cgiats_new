...
.controller("customcategoryreportcontroller", function($scope, $http, dateRangeService, $sessionStorage, $state,$window){
			...
			$scope.viewcategorysubmittals = function(period,category)
			{
				$scope.obj.timePeriod = period;
				$scope.obj.category = category;
				//alert(JSON.stringify($scope.obj));
				
				var url =  $state.href("categorysubmittalsreport",{dmName:null,startDate:$scope.obj.startDate, endDate:$scope.obj.endDate, status:$scope.obj.status, timePeriod:$scope.obj.timePeriod, category: $scope.obj.category });
				window.open(url,'_blank');
			}
...
//						 dmsInfoTableView();
			...
			function getSubmittalsByCategory(){
//				alert(JSON.stringify($scope.obj));
				
				var response = $http.post("customReports/getSubmittalsByCategory", $scope.obj);
				response.success(function(data, config, headers, status){
					if(data){
						//alert(JSON.stringify(data));
						$scope.submittalsDataByCategory = data;
					}else{
//						$scope.dmsInfoTable = true;
//						 dmsInfoTableView();
					}
			...
			function getStartsByCategory(){
//				alert(JSON.stringify($scope.obj));
				
				var response = $http.post("customReports/getStartsByCategory", $scope.obj);
				response.success(function(data, config, headers, status){
					if(data){
						//alert(JSON.stringify(data));
						$scope.startsDataByCategory = data;
					}else{
//						$scope.dmsInfoTable = true;
//						 dmsInfoTableView();
					}
