...
//    			$scope.records = data.records;
	...
	$scope.getJobOrdersDetails = function(userId,is_joborderBased){
		if(is_joborderBased==true){
			var url =  $state.href("dmjobordersreport",{dmname:userId,startDate:obj.startDate, endDate:obj.endDate,  is_joborderBased:is_joborderBased});
