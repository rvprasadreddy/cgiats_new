;(function(angular){
    ...
    .controller("dmjoborderscontroller",function($rootScope, $scope, blockUI, $http, $timeout, $filter, $mdDialog, $mdMedia, $window, $state,dateRangeService, $stateParams) {
    	...
    	function dmjoborders() {
    		...
    		var obj = {dmname : $stateParams.dmname, startdate : $stateParams.startDate, enddate : $stateParams.endDate, isJobOrderBased : $stateParams.is_joborderBased ,strStatuses : strStatuses};
