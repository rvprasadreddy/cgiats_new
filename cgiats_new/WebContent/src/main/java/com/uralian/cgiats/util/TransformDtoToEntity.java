...
//			
	...
	public static void getFilledProjectDetails(Candidate candidate, CandidateInfo candidateInfo, ClientInfo clientInfo,
		...
		candidateInfo.setEmployeeId(projectDto.getEmployeeId());
		candidateInfo.setDateOfLastContact(Utils.convertStringToDate(projectDto.getDateOfLastContact()));
		candidateInfo.setEmpRole(projectDto.getEmpRole());
		candidateInfo.setRating(projectDto.getRating());
		candidateInfo.setCurrentStatus(projectDto.getCurrentStatus());
		candidateInfo.setGlassDoorReview(projectDto.getGlassDoorReview());
		candidateInfo.setNotes(projectDto.getNotes());
		candidateInfo.setReferralNotes(projectDto.getReferralNotes());
		candidateInfo.setPreferredName(projectDto.getPreferredName());
		candidateInfo.setEmpOtherRole(projectDto.getEmpOtherRole());
		...
		if (candidateInfo != null) {
			...
			clientInfo.setBillingPartner(projectDto.getBillingPartner());
//			clientInfo.setProjectEndDate(Utils.convertStringToDate(projectDto.getProjectEndDate()));
			clientInfo.setStrProjectEndDate(projectDto.getStrProjectEndDate());
