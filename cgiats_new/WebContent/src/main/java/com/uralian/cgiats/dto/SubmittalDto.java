...
public class SubmittalDto {
	...
	private String dmId;
	private String dmOfficeLocation;
	private String recName;
	private String recOfficeLocation;
	...
	public String getRecOfficeLocation() {
		return recOfficeLocation;
	}

	public void setRecOfficeLocation(String recOfficeLocation) {
		this.recOfficeLocation = recOfficeLocation;
	}
	...
	/**
	 * @return the dmOfficeLocation
	 */
	public String getDmOfficeLocation() {
		return dmOfficeLocation;
	}

	/**
	 * @param dmOfficeLocation
	 *            the dmOfficeLocation to set
	 */
	public void setDmOfficeLocation(String dmOfficeLocation) {
		this.dmOfficeLocation = dmOfficeLocation;
	}

	/**
	 * @return the jobPosted
	 */
	...
	/**
	 * @param jobPosted the jobPosted to set
	 */
	...
	/**
	 * @return the strRecJoinDate
	 */
	public String getStrRecJoinDate() {
		return strRecJoinDate;
	}

	/**
	 * @param strRecJoinDate the strRecJoinDate to set
	 */
	public void setStrRecJoinDate(String strRecJoinDate) {
		this.strRecJoinDate = strRecJoinDate;
	}
