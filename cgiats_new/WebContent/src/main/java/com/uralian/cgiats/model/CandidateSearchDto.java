...
public class CandidateSearchDto implements Serializable {
	...
	private Boolean onlyOnAssignment;
	//
	...
	public String toString() {
		return "CandidateSearchDto [name=" + name + ", firstName=" + firstName + ", lastName=" + lastName + ", title="
				+ title + ", states=" + states + ", city=" + city + ", email=" + email + ", visaStats=" + visaStats
				+ ", resumeStats=" + resumeStats + ", startEntryDate=" + startEntryDate + ", endEntryDate="
				+ endEntryDate + ", startDate=" + startDate + ", endDate=" + endDate + ", resumeTextQuery="
				+ resumeTextQuery + ", createdBy=" + createdBy + ", properties=" + properties + ", orderByColumn="
				+ orderByColumn + ", orderByType=" + orderByType + ", startPosition=" + startPosition + ", maxResults="
				+ maxResults + "]";
	}
	...
	/**
	 * @return the onlyOnAssignment
	 */
	public Boolean getOnlyOnAssignment() {
		return onlyOnAssignment != null ? onlyOnAssignment : false;
	}

	/**
	 * @param onlyOnAssignment
	 *            the onlyOnAssignment to set
	 */
	public void setOnlyOnAssignment(Boolean onlyOnAssignment) {
		this.onlyOnAssignment = onlyOnAssignment;
	}
